...
function removeMotabeqat(ev) {
    ...
    for (var i = 0; i < MotabeqatInfos.length; i++) {
        ...
        var maghta = cardBody.getElementsByTagName('ul')[0].getElementsByTagName('li')[1].lastElementChild.innerText;
        var tedadvahed = cardBody.getElementsByTagName('ul')[0].getElementsByTagName('li')[2].lastElementChild.innerText;
