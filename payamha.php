...
<div class="container">
    <div class="row">
        ...
        <fieldset class="border  p-3 m-2 py-4 my-4 form-fieldset" >
            <legend class="font-weight-bolder small">پیام ها(درخواست های در انتظار)</legend>
            <div class=" py-3">
                ...
                <table class="table table-bordered ">
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><?php echo "??" ?></td>
                        <td><a href="form-qaboo-ya-rade-davadi.php">بیشتر</a></td>
                    </tr>
...
<div class="border p-2 m-2 form-fieldset">
    <legend class="font-weight-bolder small">درخواست های قبول شده</legend>
    <button type="button" class="btn btn-block my-5" data-toggle="collapse" data-target="#demo">  درخواست های قبول شده <span class="material-icons btn-lg ">expand_more</span> </button>
    <div id="demo" class="collapse focus large text-justify">
        <div class="form-check text-center flex-50 d-flex flex-row justify-content-around">
        <div >
           <a href="davariTarjime/form-davari-tarjome.php"> <h3>ترجمه</h3></a>
        </div>

        <div >
            <a href="formDavariTalif/form-davari-talif.php"><h3>تالیف</h3></a>
        </div>
        </div>
